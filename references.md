...
| [Grace Fuller Design, Selected Works](https://gracefullerdesign.com/selected-works/) | Public work listing, project labels, and navigation structure | A portfolio organized around individual projects, with About and Contact easily discoverable. Use Kelly's own images and a distinct identity. |

The Apple-inspired repository packages design-review guidance. It is not a reason to add native-app controls, Apple system fonts, or glass effects to this website. The iOS collection is useful for the specificity of its documentation; its black VSCO palette and editing controls are not Kelly's brand.

The Grace Fuller review establishes content/navigation inspiration. This brief does not claim a pixel-level or measured mobile audit of that website. Kelly's palette, layout dimensions, hero treatment, and brand artwork are original proposed choices in this package.
