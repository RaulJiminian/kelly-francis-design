...
Use React, JavaScript, JSX, and Vite. No TypeScript or Next.js. Follow the current user's requested scope; this handoff alone does not request an implementation.
